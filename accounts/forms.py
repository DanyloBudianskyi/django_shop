...
class UserRegistrationForm(UserCreationForm):
    ...
    avatar = forms.ImageField(required=False, help_text="Завантажте фото профілю(JPG, PNG, максимум 5MB)", label="Аватар")

    class Meta:
        model = User
        fields = ('username', 'email', 'first_name', 'last_name', 'password1', 'password2', 'bio', 'birth_date', 'location', 'website', 'avatar')
    ...
    def __init__(self, *args, **kwargs):
        ...
        help_texts = {
            ...
            "<ul class='list-disc list-inside space-y-1 text-sm text-gray-500'>"
                "<li>Пароль не повинен бути схожим на ваші особисті дані</li>"
                "<li>Мінімум 8 символів</li><li>Не може складатися лише з цифр</li>"
            "</ul>",
